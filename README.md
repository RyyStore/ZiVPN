...
```bash
wget -q https://raw.githubusercontent.com/RyyStore/ZiVPN/main/install.sh && chmod +x install.sh && ./install.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/RyyStore/ZiVPN/main/uninstall.sh && chmod +x uninstall.sh && ./uninstall.sh
```
